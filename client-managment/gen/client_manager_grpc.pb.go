...
func (c *clientManagerClient) Healthz(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (UnimplementedClientManagerServer) Healthz(context.Context, *emptypb.Empty) (*emptypb.Empty, error) {
...
func _ClientManager_Healthz_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientManagerServer).Healthz(ctx, req.(*emptypb.Empty))
	}
